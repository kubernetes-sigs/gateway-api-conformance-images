...
- [Slack channel](https://kubernetes.slack.com/messages/sig-network-gateway-api) - Replace `kubernetes-users` with your slack channel string, this will send users directly to your channel.
