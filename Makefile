...
ifndef RELEASE_TAG
	...
	$(KPROMO) pr --project gateway-api --staging-repo us-central1-docker.pkg.dev/k8s-staging-images/gateway-api --tag $(RELEASE_TAG) --reviewers "$(IMAGE_REVIEWERS)" --fork $(USER_FORK) --image conformance/echo-basic --image conformance/echo-advanced --image conformance/extauth-v3-impl
