...
const file_grpcecho_proto_rawDesc = "" +
	...
	"\tEchoThree\x128.gateway_api_conformance.echo_basic.grpcecho.EchoRequest\x1a9.gateway_api_conformance.echo_basic.grpcecho.EchoResponse\"\x00BFZDsigs.k8s.io/gateway-api-conformance-images/echo-basic/grpcechoserverb\x06proto3"
